...
#include <fstream>
#include <string>
SCDLLName ("LOG - PERZIST VARS")

//dat do grafu kde vsechno vypisu 
SCSFExport scsf_ReadValuesFromPerzistVarsAndLogEntryDetails(SCStudyInterfaceRef sc)
{
	if (sc.SetDefaults)
	{
		...
		sc.GraphName = "Read the perzists and log entry details";
